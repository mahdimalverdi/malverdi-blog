...
من این مسئله را فقط «اجرای بد اسکرام» نمی‌دانم. به نظرم خودِ قاب اسکرام، با اسپرینت، بک‌لاگ، امتیازدهی، مراسم تکرارشونده و نقش‌های ثابت، خیلی راحت توجه تیم را از هدف واقعی به اداره‌ی فرایند منتقل می‌کند. مسئله از جایی شروع می‌شود که به‌جای اینکه بپرسیم «چه تغییری باید در واقعیت ایجاد شود؟»، می‌پرسیم «در این اسپرینت چه آیتم‌هایی را جا می‌دهیم؟».

برای همین دفاع رایج «این اسکرام واقعی نیست» قانع‌کننده نیست. چارچوب‌ها فقط با تعریف کتابی‌شان سنجیده نمی‌شوند؛ با رفتاری هم سنجیده می‌شوند که در فشار کار روزمره تولید می‌کنند. اگر یک قالب بارها تیم را به سمت تسک‌محوری، عددسازی، پرکردن جلسه و گزارش‌دادن از حرکت سوق می‌دهد، نمی‌شود همه‌ی تقصیر را گردن آدم‌ها انداخت. باید پرسید خودِ قالب چه چیزی را آسان‌تر کرده و چه چیزی را از مرکز توجه بیرون رانده است.
...
این خروجی نباید صورت‌جلسه‌ی مفصل باشد. اگر برای حذف جلسه، دفتر و دستک تازه بسازیم، فقط هزینه را از تقویم به متن منتقل کرده‌ایم. خروجی خوب کوتاه، تصمیم‌محور و قابل ارجاع است: چند خط که آدم بعدی با خواندن آن بفهمد چه چیزی قطعی شده، چه چیزی باز مانده و برای ادامه باید سراغ چه کسی یا چه تغییری برود.
...
برای همین در مدل سالم، مالک تنها نیست. کنار مالک باید بازبین باشد، برای هدف‌های مهم نفر پشتیبان داشته باشیم، تصمیم‌ها در دفترچه‌ی تصمیم‌ها ثبت شوند و اگر کار قرار است طولانی شود، یادداشت انتقال کار وجود داشته باشد. این‌ها هزینه دارند، اما هزینه‌شان از جلسه‌های عمومی طولانی کمتر است و خروجی‌شان هم ماندگارتر است.
...
- تصمیم‌ها و دلیلشان در دفترچه‌ی تصمیم‌ها ثبت شود؛ مخصوصاً تصمیم‌هایی که بعداً ممکن است محل اختلاف شوند.
...
یادداشت جهت‌دهی نقطه‌ی شروع است. لازم نیست طولانی باشد. کافی است بگوید چرا این کار مهم است، چه مسئله‌ای را می‌خواهیم حل کنیم، چه چیزی فعلاً اولویت ندارد و چه ابهام‌هایی از همان ابتدا دیده می‌شود. این یادداشت کمک می‌کند جلسه جای فکرکردن اولیه را نگیرد.

بعد از آن هدف باید دقیق شود. هدف خوب فقط اسم یک فیچر نیست. باید معلوم کند چه تغییری می‌خواهیم ایجاد کنیم و خروجی قابل استفاده یعنی چه. مثلاً «ساخت صفحه‌ی تاریخچه سفارش» هدف نیست؛ هدف می‌تواند این باشد که «کاربر بدون تماس با پشتیبانی بتواند وضعیت سفارش‌های قبلی‌اش را بفهمد». این تفاوت کوچک، مسیر تصمیم‌ها را عوض می‌کند.

مرحله‌ی بعد مالک هدف است. مالک قرار نیست همه‌ی کار را خودش انجام دهد، اما باید جهت را نگه دارد، افراد مرتبط را وارد کند، ابهام‌ها را جمع کند و نگذارد تصمیم‌ها پخش و بی‌صاحب بمانند. اگر هدف مالک نداشته باشد، معمولاً یا وسط کار گم می‌شود یا به مجموعه‌ای از تسک‌های جدا از هم تبدیل می‌شود.

بعد نوبت سینک کوچک با افراد مرتبط است. این سینک وقتی لازم است که نوشتار کافی نباشد یا چند نفر واقعاً باید یک تصمیم مشترک بگیرند. شرکت‌کننده‌ها از روی مسئله انتخاب می‌شوند، نه از روی عضویت در تیم. خروجی این سینک باید تصمیم باشد، نه صرفاً گفت‌وگو.

ثبت تصمیم، محدوده و وابستگی‌ها بخش حیاتی مدل است. اگر جلسه‌ای برگزار شد اما خروجی‌اش به متن برنگشت، دوباره به همان حافظه‌ی کوتاه‌مدت جمعی برگشته‌ایم. باید معلوم باشد چه تصمیمی گرفتیم، چرا گرفتیم، چه چیزی داخل محدوده است، چه چیزی بیرون محدوده است، چه وابستگی‌هایی داریم و قدم بعدی چیست.

آخرین مرحله، بازبینی خروجی است؛ نه شمارش جلسه‌ها و نه فقط شمارش تسک‌های بسته‌شده. باید ببینیم آیا خروجی واقعاً به هدف نزدیک شده یا نه. اگر نه، مسئله ممکن است در تعریف هدف، تصمیم‌های میانی، وابستگی‌ها یا حتی خود فرض اولیه بوده باشد. این نوع بازبینی درباره‌ی یادگیری تیم است، نه گزارش‌گیری از آدم‌ها.
...
من از پلنینگ‌های تیمی فراری‌ام، چون خیلی وقت‌ها مسئله‌ی درست را حل نمی‌کنند. اسکرام هم به نظرم این مشکل را کم نکرده؛ در بسیاری از تیم‌ها فقط برای آن زبان، نقش، مراسم و عدد ساخته است. قرار است هماهنگی بسازد، اما گاهی فقط تمرکز را می‌گیرد. قرار است شفافیت بسازد، اما گاهی فقط حضور می‌سازد. قرار است برنامه بدهد، اما گاهی فقط آینده‌ی مبهم را عددی و مرتب نشان می‌دهد.
