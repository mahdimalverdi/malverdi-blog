...
معیارها هم رفتار می‌سازند. اگر فقط تعداد قابلیت‌های تحویلی، سرعت بستن تسک یا تاریخ تحویل را بسنجیم، تیم به سمت تحویل سریع‌تر و سطحی‌تر هل داده می‌شود. اما اگر کیفیت بازبینی، نرخ خطا بعد از انتشار، زمان کشف خطا، زمان بازیابی و میزان بازپرداخت بدهی فنی هم دیده شود، پیام مدیریتی فرق می‌کند: کیفیت بخشی از کار است، نه چیزی که بعداً اگر وقت شد به آن برسیم.

اگر تیم برای گفتن «این آماده نیست» امنیت نداشته باشد، دیر یا زود یاد می‌گیرد ریسک را پنهان کند. اگر خطاها با سرزنش پاسخ داده شوند، تیم به جای یادگیری، دفاعی می‌شود.
